    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("24d71ac2-0a9c-4914-9fd3-13bc25d42694"), new Guid("735886c0-faf3-49ca-9776-8a20b756f1cb"), "Product C", 7, 177.8m, 25.40m },
                    { new Guid("2e27b6a4-469d-4d7f-8b8b-54af129675fd"), new Guid("f4816224-70d6-4491-ac52-34f298ace16f"), "Product B", 3, 46.50m, 15.50m },
                    { new Guid("ac90b8bc-349d-43fd-87a6-6a7ed8057697"), new Guid("735886c0-faf3-49ca-9776-8a20b756f1cb"), "Product D", 4, 48.00m, 12.00m },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("735886c0-faf3-49ca-9776-8a20b756f1cb"), "Jane Smith", new DateTime(2024, 1, 22, 15, 30, 49, 367, DateTimeKind.Local).AddTicks(5879), "ORD002", 225.8m },
                    { new Guid("f4816224-70d6-4491-ac52-34f298ace16f"), "John Doe", new DateTime(2024, 1, 22, 15, 30, 49, 367, DateTimeKind.Local).AddTicks(5860), "ORD001", 66.5m }
                });
        }
