...
namespace Entities
{
    ...
    {
        /// <summary>
        /// Intializes a new instance of the <see cref="ApplicationDbContext"/> class
        /// </summary>
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Map the Order entity to orders table
            modelBuilder.Entity<Order>().ToTable("Orders");
            //Mapo the OrderItem entity to the order items table
            modelBuilder.Entity<OrderItem>().ToTable("OrderItems");

            //Feeding sample data into Orders table
            ...
            //Feeding sample data into OrderItems table
            modelBuilder.Entity<OrderItem>().HasData(
                ...
                new OrderItem { OrderItemId = Guid.Parse("24D71AC2-0A9C-4914-9FD3-13BC25D42694"), OrderId = Guid.Parse("735886C0-FAF3-49CA-9776-8A20B756F1CB"), ProductName = "Product C", Quantity = 7, UnitPrice = 25.40m, TotalPrice = 177.8m },
                new OrderItem { OrderItemId = Guid.Parse("AC90B8BC-349D-43FD-87A6-6A7ED8057697"), OrderId = Guid.Parse("735886C0-FAF3-49CA-9776-8A20B756F1CB"), ProductName = "Product D", Quantity = 4, UnitPrice = 12.00m, TotalPrice = 48.00m }
            );
        }
    }
}
